...
const GoogleIcon = (
  <svg width="18" height="18" viewBox="0 0 24 24">
    <path fill="var(--theme-danger)" d="M5.27 12c0-.82.14-1.61.38-2.35L2.2 7.09A11.95 11.95 0 0 0 0 12c0 1.97.48 3.84 1.32 5.48l3.45-2.56A7.16 7.16 0 0 1 5.27 12"/>
    ...
    <path fill="var(--theme-warning)" d="M5.27 12c0-.82.14-1.61.38-2.35l-3.7-2.32A11.9 11.9 0 0 0 .8 12c0 1.97.48 3.84 1.32 5.48l3.45-2.56A7.16 7.16 0 0 1 5.27 12"/>
    <path fill="var(--theme-success)" d="M12 19.09c-1.77 0-3.37-.61-4.63-1.8l-3.48 3.48A11.95 11.95 0 0 0 12 24c3.3 0 6.27-1.34 8.44-3.48l-3.6-2.64C13.6 18.13 12.87 19.09 12 19.09"/>
...
const OAuthButton = memo(function OAuthButton({
  ...
  return (
    <button
      ...
      className={`group relative w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-surface-elevated backdrop-blur-glass border border-border hover:border-primary/40 hover:bg-surface-elevated backdrop-blur-glass transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-focus/30 focus:ring-offset-2 focus:ring-offset-[var(--theme-bg)] ${className}`}
      aria-label={label}
      type="button"
    >
      {loading ? (

...
export default memo(function ChatScreenMockup() {
  return (
    <DeviceFrame type="phone">
      <ChatHeader name="Alex Rivera" online avatarColor="var(--theme-success)" />
      <div className="p-3 min-h-[360px]">
        ...
        >
          <TypingDots />
          <span className="text-[10px] text-text-secondary">Alex is typing...</span>
        </motion.div>
      </div>
      <div className="px-3 py-2 border-t border-border flex items-center gap-2">
        <div className="flex-1 h-8 rounded-lg bg-surface-elevated backdrop-blur-glass border border-border flex items-center px-2.5">

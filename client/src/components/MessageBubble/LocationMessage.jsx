...
function LocationMessage({ message }) {
  ...
  return <div className="w-[min(320px,calc(100vw-32px))] max-w-full cursor-pointer overflow-hidden rounded-xl border border-border/[.55] dark:border-border-dark/[.55] bg-surface-elevated dark:bg-surface-elevated-dark/[.94]">
    <div className="relative h-32 overflow-hidden bg-[linear-gradient(135deg,#d7e4d0,#b7d2df)]" aria-label="Map preview">
      ...
      <span className="absolute left-1/2 top-1/2 grid h-[38px] w-[38px] -translate-x-1/2 -translate-y-1/2 rotate-[-45deg] place-items-center rounded-[999px_999px_999px_0] bg-danger dark:bg-danger-dark text-white"><FiMapPin className="rotate-45" aria-hidden="true" /></span>
